...
var css = '#toggle-sidepanel{position:fixed;right:-24px;transform:rotate(90deg);top:37px;background-color:rgba(0,0,0,.75);padding:10px;z-index:5000;font-size:15px;text-transform:uppercase;transition:background-color,right .2s ease-in-out;cursor:pointer}#toggle-sidepanel:hover{background-color:rgba(60,60,60,.6)}#comcenter-friends{width:0!important;transition:width .2s ease-in-out;background-color:rgba(0, 0, 0, 0.8)!important}#base-bf4-html #base-header,#base-bf4-html #unified-game-manager{right:0}#base-bf4-html #viewport{padding-right:0}#base-bf4-html #base-background{margin-left:0}.show-sidepanel #comcenter-friends{width:237px!important}.show-sidepanel #toggle-sidepanel{right:213px!important}#base-container:before{height:64px!important}.game-bar .battlelog-logo{position:absolute;top:-1px;left:-87px;z-index:1000}.game-bar .battlelog-logo .logo{display:block;width:80px;height:48px;background:url(//d34ymitoc1pg7m.cloudfront.net/common/battlelog-logo-082bd9ee.png) 0 50% no-repeat;background-size:contain}#uioverlay .uioverlaysectionleft{left:20px!important}#selected-server-scoreboard .box-content{min-height:67px!important}#comcenter-tab-friends-content{width:237px!important}#bblog-icon{top:58px!important}#bblog-teamspeak{top:217px!important}#serverbrowser .servers-list tbody .server-row{height:63px!important}#base-header-secondary-nav{line-height:initial!important}#friendlist-header .icon-search{display:none}.show-sidepanel #friendlist-header .icon-search{display:initial}#main-postlistsmall footer:hover{background:rgba(7,7,7,0.6)!important}.get-bfh-tile,#cookie-preferences,#serverbrowser-show .bblog-local-comment{display:none}#uioverlay{width: 100% !important;height:calc(100% + 16px)}#weapon-statistics .stat-details h4{height:25px!important}#weapon-statistics .stat-details .image-container .squarelarge{margin-top:-31%!important;margin-bottom:-32%!important}#weapon-statistics .stat-details .track-weapon-stats li{height:18px!important;line-height:18px!important}#weapon-statistics .stat-details footer a {padding:10px!important}#weapon-statistics ul.weapon-accessories li{height:36px!important;padding-top:7px!important}.base-game-selector,.gate-actions .btn-get-game{display:none}.gate-actions{margin-bottom:0!important}.gate-actions .btn-login{width:100%}'
    head = document.head,
...
var waitForBattleLog = function() {
    ...
    $J('#community-bar .battlelog-logo').appendTo($J('#base-header .game-bar .inner-wrapper .grid-container'));
